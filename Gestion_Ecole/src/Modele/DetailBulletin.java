...
public class DetailBulletin {
    ...
    public DetailBulletin(int _ID, int _ID_Bulletin, int _ID_Enseignement, int _coefficient, String _appreciation) {
        this.ID = _ID;
    ...
    public void ajouterEvaluation(int cleEvaluationMax, Evaluation val) {
        this.evaluations.put(cleEvaluationMax, val);
        // augmenter la cle max
    }
   
    public void supprimerEvaluation(int cleSupp) {
        this.evaluations.remove(cleSupp);
    }
