 ...
 * @author pierr
 */
public class Notes_Etudiant_par_Directeur extends javax.swing.JFrame {

    /**
     * Creates new form Notes_Etudiant_par_Directeur
     */
    ...
    public Notes_Etudiant_par_Directeur(String id, String name, String surname, String classe) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Notes_Etudiant_par_Directeur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Notes_Etudiant_par_Directeur().setVisible(true);
            }
        });
    }
    */
