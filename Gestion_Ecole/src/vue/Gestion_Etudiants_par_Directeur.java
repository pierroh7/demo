 ...
 * @author pierr
 */
public class Gestion_Etudiants_par_Directeur extends javax.swing.JFrame {
    ...
    public Gestion_Etudiants_par_Directeur() {
        initComponents();
...
//GEN-LAST:event_jButton2MouseClicked
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        // TODO add your handling code here:
        Notes_Etudiant_par_Directeur profil = new Notes_Etudiant_par_Directeur(txt_id.getText(), txt_name.getText(), txt_surname.getText(), txt_class.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gestion_Etudiants_par_Directeur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
